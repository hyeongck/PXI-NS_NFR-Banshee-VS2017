...
namespace ProductionLib2
{
    public partial class ProductionTestInputForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Admin mode
            if (EnablePassword == true && txtOperatorID.Text.CIvEqualsAnyOf("AVGO155", ENGR_Password))
            {
            ...
            {
                if (txtLotID.Text.StartsWith("PT") || txtLotID.Text.StartsWith("FT"))
                {
