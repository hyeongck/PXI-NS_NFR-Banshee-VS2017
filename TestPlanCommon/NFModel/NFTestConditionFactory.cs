...
namespace TestPlanCommon.NFModel
{
    ...
    {
        public Dictionary<string, string>[] DicTestPA;  // Sheet - Condition_PA : Test Header, Test Condition
        public Dictionary<string, string> DicTestLabel; // Sheet - Condition_PA : Test Header, Test Label (=dBm, MHz ...)

        public Dictionary<string, string> DicCalInfo;   // Sheet - CalInfo : CalInfo Header, CalInfo Condition

        public Dictionary<string, string> DicWaveForm;  // Sheet - WaveForm : WaveformName, WaveformFilePath
        public Dictionary<string, string> DicWaveFormMutate; // Sheet - WaveForm : WaveformName, WaveformMutateCond
        public Dictionary<string, string> DicWaveFormAlias; // Sheet - WaveForm : WaveformName, WaveformAlias

        public Dictionary<string, string>[] DicMipiKey; // Sheet - MIPI : currentTestCondName, currentTestCondValue
        public Dictionary<string, string>[] DicPwrBlast; // Sheet - Power Blast : currentTestCondName, currentTestCondValue

        public ArrayList CalList;
    }
