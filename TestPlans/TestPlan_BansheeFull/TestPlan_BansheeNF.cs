...
namespace TestPlan_BansheeFull
{
    public class BansheeNF : TestPlanBase, IATFTest
    {
        ...
        MyUtility myUtility = new MyUtility();  //Ivan
        ...
        private bool bCurrentGUCal = false;
        ...
        Dictionary<string, string> DicCalInfo;  //Ivan
        public static string LocSetFilePath;  //Ivan
        string error = ""; 

        public s_MIPI_PAIR[] tmp_mipiPair { get; private set; }
        ...
        public override string DoATFInit(string args)
        {
            ...
            FirstTest = true;
            ProductionTestInputForm prodInputForm;  //Ivan
            prodInputForm = new ProductionTestInputForm();  //Ivan
            ...
            LocSetFilePath = Convert.ToString(MyDUT.DicCalInfo[DataFilePath.LocSettingPath]);
            ...
            if (MIPImodel == "DM482E")
            {
                ...
                LibEqmtDriver.MIPI.Lib_Var.SlaveAddress = Convert.ToInt32(myUtility.DicLocalfile["MIPI_Config"]["Slave_Address"], 16);
                LibEqmtDriver.MIPI.Lib_Var.ChannelUsed = Convert.ToInt32(myUtility.DicLocalfile["MIPI_Config"]["Channel_Used"]);
                ...
                if (loadboardID == "NaN" || socketID == "NaN")
                {
                    programLoadSuccess = false;
                    MessageBox.Show("LoadboardID or ContactorID was not read successfully.\nPlease resolve errors and reload program.", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            m_NFTpProd.ShowInputGui(pjtTagNum, SkipProdGUIFlag);
        ...
        private string SearchLocalSettingDictionary(string sMainKey, string sSubKey)
        ...
        public override ATFReturnResult DoATFTest(string args)
        {
            ...
            if (FirstTest == true)
            {
                ResultBuilder.M_Previous_OTP_MODULE_ID2 = -1;  //DH DuplicateID
        ...
        public void ChkPauseOnDuplicatedID()
        {
            ...
            try
            {
                ...
                //DicOTPModuleID = new Dictionary<long, long>();
            }
            catch
            {
        ...
        public bool ChkDuplicatedDUT()
        {
            ...
            //if (!DicOTPModuleID.ContainsKey(ResultBuilder.M_OTP_MODULE_ID))

            //if (PauseOnDuplicateID && !bCurrentGUCal)
            if (PauseOnDuplicateID && !AvagoGU.GU.runningGU)
            {
                ...
                if (FirstTest || ((ResultBuilder.M_Previous_OTP_MODULE_ID2 != ResultBuilder.M_OTP_MODULE_ID || ResultBuilder.M_Previous_OTP_CheckAll2 != ResultBuilder.M_OTP_CheckAll)
                    || ((ClothoDataObject.Instance.EnableOnlySeoulUser && Math.Round((double)ResultBuilder.M_OTP_MODULE_ID, 0) == 0))))
                {
                ...
                ResultBuilder.M_Previous_OTP_MODULE_ID2 = ResultBuilder.M_OTP_MODULE_ID;
                ResultBuilder.M_Previous_OTP_CheckAll2 = ResultBuilder.M_OTP_CheckAll;
