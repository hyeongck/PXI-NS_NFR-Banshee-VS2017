...
namespace MyProduct
{
    public static class ResultBuilder
    {
        ...
        public static long M_Previous_OTP_CheckAll2 { get; set; }
        //correlation factor 
        ...
        public static void BuildResults(ref ATFReturnResult results, string paraName, string unit, double value)
        {
            if (paraName.Contains("MFG") || (paraName.Contains("OTP_MODULE_ID") && !(paraName.Contains("_2"))))
            {
                ...
                else
                {
                    ...
                    if ((M_OTP_MODULE_ID == M_Previous_OTP_MODULE_ID) && (M_OTP_CheckAll == M_Previous_OTP_CheckAll))
                    {
                        value = -1;
                    }
                    else
                    {
                        M_Previous_OTP_MODULE_ID = M_OTP_MODULE_ID;
